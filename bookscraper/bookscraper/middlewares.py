...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_fake_browser_headers_active = settings.get('SCRAPEOPS_FAKE_BROWSER_HEADER_ENABLED', True) # Set to True
        self.scrapeops_num_results = settings.get('SCRAPEOPS_NUM_RESULTS')
        self.headers_list = []
    ...
    # In the above code you might run into a KeyError if the key is not found in the dictionary.
    # This means the API response does not always include this key.
    # To handle this gracefully, you can use the .get() method on the dictionary object.
